...
class TestRightBoundaryConflicts:
    ...
    def test_shorter_suffix_that_resolves_correctly_blocks_longer(self) -> None:
        ...
        result, _ = resolve_conflicts_for_group(corrections, BoundaryType.RIGHT)
...
class TestPrefixBoundaryConflicts:
    ...
    def test_shorter_prefix_that_resolves_correctly_blocks_longer(self) -> None:
        ...
        result, _ = resolve_conflicts_for_group(corrections, BoundaryType.LEFT)
    ...
    def test_none_boundary_blocks_longer_prefix(self) -> None:
        ...
        result, _ = resolve_conflicts_for_group(corrections, BoundaryType.NONE)
    ...
    def test_both_boundary_blocks_longer_prefix(self) -> None:
        ...
        result, _ = resolve_conflicts_for_group(corrections, BoundaryType.BOTH)
...
class TestEdgeCases:
    ...
    def test_empty_list_returns_empty(self) -> None:
        result, _ = resolve_conflicts_for_group([], BoundaryType.NONE)
        assert result == []
...
class TestBehaviorConsistency:
    ...
    def test_shorter_kept_regardless_of_input_order(self) -> None:
        ...
        result_normal, _ = resolve_conflicts_for_group(corrections_normal, BoundaryType.NONE)
